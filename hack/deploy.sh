...
# `quay.io/projectquay/quay-bridge-operator:1.1.2`. you can override the
...
#  - bundle/quay-bridge-operator.catalogsource.yaml
#  - bundle/quay-bridge-operator.operator-group.yaml
#  - bundle/quay-bridge-operator.subscription.yaml
...
export CATALOG_PATH=${CATALOG_PATH:-'./bundle/quay-bridge-operator.catalogsource.yaml'}
export CATALOG_IMAGE=${CATALOG_IMAGE:-"quay.io/projectquay/quay-bridge-operator-index:${TAG}"}
export OG_PATH=${OG_PATH:-'./bundle/quay-bridge-operator.operatorgroup.yaml'}
export SUBSCRIPTION_PATH=${SUBSCRIPTION_PATH:-'./bundle/quay-bridge-operator.subscription.yaml'}
export OPERATOR_PKG_NAME=${OPERATOR_PKG_NAME:-'quay-bridge-operator'}
